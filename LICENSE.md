...
> Vencord theme collection, AMOLED dark and colorful 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🎨 &nbsp;**AMOLED dark** — pure black for OLED displays

🌊 &nbsp;**Gradient themes** — smooth color gradient designs

🎮 &nbsp;**Gaming** — game-inspired themes for every taste

🌿 &nbsp;**Nature** — calm earth-tone themes

🔄 &nbsp;**Quick switch** — change themes from settings

✏️ &nbsp;**Variables** — tweak colors without editing CSS
